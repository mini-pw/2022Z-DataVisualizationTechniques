...
poland_spdf <- readOGR( dsn= "./poland_map" , layer="poland_administrative_boundaries_province_polygon", verbose=FALSE) 
...
ggplot() +
  ...
  labs(title = "Nighttime Road Noise Pollution in Poland", 
